...
| `Adapting Large Language Models by Integrating Collaborative Semantics for Recommendation.pdf` | 中科大 | 2023 | 推荐 | 学术 | LLM-based recommendation, collaborative semantics, item indexing, vector quantization, alignment tuning |
...
| `Reasoning over Semantic IDs Enhances Generative Recommendation.pdf` | 新加坡国立 / 中科大 | 2026 | 推荐 | 学术 | generative recommendation, semantic IDs, SID-language alignment, LLM reasoning, reinforced optimization |
...
| `Bi-Level Optimization for Generative Recommendation: Bridging Tokenization and Generation.pdf` | 中科大 / 北航 | 2025 | 推荐 | 学术 | generative recommendation, bi-level optimization, item tokenization, meta-learning, gradient surgery |
...
| `FuXi-$α$: Scaling Recommendation Model with Feature Interaction Enhanced Transformer.pdf` | 中科大 / 华为 | 2025 | 推荐 | 工业 | scaling law, feature interaction, Adaptive Multi-channel Self-attention, Multi-stage FFN, sequential recommendation |
| `Killing Two Birds with One Stone: Unifying Retrieval and Ranking with a Single Generative Recommendation Model.pdf` | 中科大 / 华为 | 2025 | 推荐 | 工业 | generative recommendation, unifying retrieval and ranking, ranking-driven enhancer, gradient-guided adaptive weighter, sequence generation |
...
| `Towards Context-aware Reasoning-enhanced Generative Searching in E-commerce.pdf` | 中科大 / 快手 | 2025 | 搜索 | 工业 | generative search, context-aware recommendation, reasoning-enhanced recommendation, self-evolving post-training, debiased GRPO |
...
| `Learning from Emptiness: De-biasing Listwise Rerankers with Content-Agnostic Probability Calibration.pdf` | 中科大 / 阿里 | 2026 | 搜索 | 工业 | listwise reranking, position bias, probability calibration, training-free, entropy-adaptive contrastive |
...
| `TALLRec: An Effective and Efficient Tuning Framework to Align Large Language Model with Recommendation.pdf` | 中科大 | 2023 | 推荐 | 学术 | instruction tuning, LLM alignment, recommendation, cross-domain generalization, parameter efficiency |
| `LLaRA: Large Language-Recommendation Assistant.pdf` | 中科大 | 2023 | 推荐 | 学术 | sequential recommendation, hybrid prompting, ID embeddings, curriculum learning, LLM |
...
| `Customizing Language Models with Instance-wise LoRA for Sequential Recommendation.pdf` | 中科大 | 2024 | 推荐 | 学术 | sequential recommendation, instance-wise LoRA, mixture-of-experts, parameter-efficient fine-tuning, negative transfer |
...
| `AlphaFuse: Learn ID Embeddings for Sequential Recommendation in Null Space of Language Embeddings.pdf` | 中科大 / 新加坡国立 | 2025 | 推荐 | 学术 | sequential recommendation, ID embeddings, language embeddings, null space, singular value decomposition |
...
| `Leveraging Memory Retrieval to Enhance LLM-based Generative Recommendation.pdf` | 中科大 / 新加坡国立 | 2024 | 推荐 | 学术 | generative recommendation, memory retrieval, long-term interests, LLM-based recommendation, next-item generation |
...
| `Token-level Collaborative Alignment for LLM-based Generative Recommendation.pdf` | 中科大 / Rutgers | 2026 | 推荐 | 学术 | generative recommendation, collaborative filtering, token-level alignment, soft label alignment, next-token prediction |
...
| `Beyond Static Best-of-N: Bayesian List-wise Alignment for LLM-based Recommendation.pdf` | 中科大 / 浙大 | 2026 | 推荐 | 学术 | list-wise alignment, Best-of-N, Bayesian framework, LLM4Rec, ranking metrics |
...
| `SPRec: Self-Play to Debias LLM-based Recommendation.pdf` | 中科大 / 香港科技大学 | 2024 | 推荐 | 学术 | self-play, debiasing, DPO, fairness, filter bubble |
...
| `Reason4Rec: Deliberative User Preference Alignment of Large Language Models for Recommendation.pdf` | 中科大 / 中关村学院 | 2025 | 推荐 | 学术 | deliberative recommendation, preference alignment, reasoning, step-wise experts |
| `CoLLM: Integrating Collaborative Embeddings into Large Language Models for Recommendation.pdf` | 中科大 | 2023 | 推荐 | 学术 | collaborative embeddings, LLMRec, cold-start, warm-start, token embedding space |
...
| `Process-Supervised LLM Recommenders via Flow-guided Tuning.pdf` | 中科大 / 香港科技大学 | 2025 | 推荐 | 学术 | GFlowNet, process supervision, token-level reward propagation, popularity bias, diversity |
...
| `LLM2Rec: Large Language Models Are Powerful Embedding Models for Sequential Recommendation.pdf` | 新加坡国立 / 中科大 | 2025 | 推荐 | 学术 | sequential recommendation, embedding model, collaborative filtering, supervised fine-tuning, item embeddings |
...
| `Uncertainty-aware Generative Recommendation.pdf` | 中科大 | 2026 | 推荐 | 学术 | generative recommendation, uncertainty, preference optimization, confidence alignment, risk-aware |
...
| `DualGR: Generative Retrieval with Long and Short-Term Interests Modeling.pdf` | 中科大 / 快手 | 2025 | 推荐 | 工业 | generative retrieval, long-short term interests, semantic ID decoding, exposure-aware next-token prediction, dual-branch routing |
...
| `Molar: Multimodal LLMs with Collaborative Filtering Alignment for Enhanced Sequential Recommendation.pdf` | 中科大 | 2024 | 推荐 | 学术 | multimodal LLM, collaborative filtering, sequential recommendation, post-alignment, multimodal item representation |
...
| `Hierarchical Time-Aware Mixture of Experts for Multi-Modal Sequential Recommendation.pdf` | 中科大 / 南航 | 2025 | 推荐 | 学术 | multi-modal sequential recommendation, mixture of experts, temporal embedding, multi-task learning, contrastive learning |
...
| 08 | TALLRec (中科大, 2023) | https://arxiv.org/abs/2305.00447 |
| 09 | LLaRA (中科大, 2023) | https://arxiv.org/abs/2312.02445 |
| 10 | LC-Rec (中科大, 2023) | https://arxiv.org/abs/2311.09049 |
